...
{
  public class TrainingReportDepsartmentsAssignmentComplition : global::Sungero.Reporting.Server.Report, global::Sungero.ClassModul.ITrainingReportDepsartmentsAssignmentComplition
  {
    ...
    protected override void FillDataSources(global::FastReport.Report report)
    {
      ...
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ClassModul.TrainingReportDepsartmentsAssignmentComplitionServerHandlers");
      if (type != null)
      {
      }
      else
    ...
    public TrainingReportDepsartmentsAssignmentComplition()
    {
      ...
      this.Handlers = type != null
        ...
        : new global::Sungero.ClassModul.TrainingReportDepsartmentsAssignmentComplitionServerHandlers(this);
    }
  }
}
...
{
  public partial class TrainingReportDepsartmentsAssignmentComplitionServerHandlers : global::Sungero.Reporting.ReportServerHandlers
  {
    ...
    public TrainingReportDepsartmentsAssignmentComplitionServerHandlers(global::Sungero.ClassModul.ITrainingReportDepsartmentsAssignmentComplition report) : base(report) { }
  }
}
...
// ==================================================================
// TrainingReportDepsartmentsAssignmentComplitionQueries.g.cs
// ==================================================================
...
{
  public class TrainingReportDepsartmentsAssignmentComplition
  {
    private static global::Sungero.Domain.SqlQueryResolver resolver = new global::Sungero.Domain.SqlQueryResolver("Sungero.ClassModul.Server.Reports.TrainingReportDepsartmentsAssignmentComplition.TrainingReportDepsartmentsAssignmentComplitionQueries.xml", System.Reflection.Assembly.GetExecutingAssembly());
    public static string CreateSoursTable
    {
       get { return resolver.GetQuery("CreateSoursTable"); }
    }
    public static string SelectDepartmentsFromTempTable
    {
       get { return resolver.GetQuery("SelectDepartmentsFromTempTable"); }
    }
  }
}
