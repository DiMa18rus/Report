...
{
  public class UsersConnectLC : global::Sungero.Reporting.Client.Report, global::Sungero.ClassModul.IUsersConnectLC
  {
    ...
    {
      var type = global::Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.ClassModul.UsersConnectLCClientHandlers");
      this.Handlers = type != null
        ? global::Sungero.Metadata.Services.AppliedTypesManager.CreateTypeInstance(type, new object[] { this })
        : new global::Sungero.ClassModul.UsersConnectLCClientHandlers(this);
    }
  }
}
