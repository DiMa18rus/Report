...
{
  partial class EmployeeReportClientHandlers
  {
    ...
    public override void BeforeExecute(Sungero.Reporting.Client.BeforeExecuteEventArgs e)
    {
      ...
      if (dialog.Show() == DialogButtons.Ok)
      {
        if (businessUnit != null)
          EmployeeReport.BusinessUnit = businessUnit.Value;
        if (department != null)
          EmployeeReport.Department = department.Value;
        if (isConnect != null)
          EmployeeReport.NoConnect = isConnect.Value.Value;
        if (filterDepartmentsForBusinessUnits != null)
          EmployeeReport.FilterDepartmentsForBusinessUnits = filterDepartmentsForBusinessUnits.Value.Value;
        if (isFilterForBusinessUnit != null)
          EmployeeReport.FilterEmployeesForBusinessUniit = isFilterForBusinessUnit.Value.Value;
        if (isFilterForDepartment != null)
          EmployeeReport.FilterinEmployeeForDepartment = isFilterForDepartment.Value.Value;
      }
      else
      {
        e.Cancel = true;
